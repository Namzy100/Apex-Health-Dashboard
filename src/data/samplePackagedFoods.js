...
export const packagedFoods = [
  ...
  // ── Coffee & Drinks ───────────────────────────────────────────
  { id: 'pkg-31', brand: 'Generic', name: 'Black Coffee (brewed)', servingSize: '8 fl oz (240ml)', servingUnit: 'cup', servingGrams: 240, calories: 2, protein: 0.3, carbs: 0, fat: 0, emoji: '☕', category: 'drink', barcode: null, source: 'usda', tags: ['coffee', 'drink', 'zero-cal'] },
  { id: 'pkg-32', brand: 'Generic', name: 'Coffee with Milk (splash)', servingSize: '8 fl oz', servingUnit: 'cup', servingGrams: 240, calories: 20, protein: 1, carbs: 2, fat: 0.8, emoji: '☕', category: 'drink', barcode: null, source: 'local', tags: ['coffee', 'drink'] },
  { id: 'pkg-33', brand: 'Generic', name: 'Espresso', servingSize: '1 shot (30ml)', servingUnit: 'shot', servingGrams: 30, calories: 5, protein: 0.3, carbs: 0.5, fat: 0.2, emoji: '☕', category: 'drink', barcode: null, source: 'usda', tags: ['coffee', 'espresso', 'drink'] },
  { id: 'pkg-34', brand: 'Generic', name: 'Latte (whole milk)', servingSize: '16 fl oz (480ml)', servingUnit: 'cup', servingGrams: 480, calories: 190, protein: 11, carbs: 18, fat: 7, emoji: '☕', category: 'drink', barcode: null, source: 'local', tags: ['coffee', 'latte', 'starbucks', 'drink'] },
  { id: 'pkg-35', brand: 'Generic', name: 'Cappuccino (2% milk)', servingSize: '12 fl oz (360ml)', servingUnit: 'cup', servingGrams: 360, calories: 120, protein: 8, carbs: 12, fat: 4.5, emoji: '☕', category: 'drink', barcode: null, source: 'local', tags: ['coffee', 'cappuccino', 'drink'] },
  { id: 'pkg-36', brand: 'Generic', name: 'Cold Brew Coffee (black)', servingSize: '12 fl oz (360ml)', servingUnit: 'bottle', servingGrams: 360, calories: 5, protein: 0.5, carbs: 0, fat: 0, emoji: '🧊', category: 'drink', barcode: null, source: 'local', tags: ['coffee', 'cold brew', 'drink'] },
  { id: 'pkg-37', brand: 'Generic', name: 'Iced Coffee (black)', servingSize: '16 fl oz', servingUnit: 'cup', servingGrams: 480, calories: 3, protein: 0.4, carbs: 0, fat: 0, emoji: '☕', category: 'drink', barcode: null, source: 'local', tags: ['coffee', 'iced coffee', 'drink'] },
  { id: 'pkg-38', brand: 'Generic', name: 'Green Tea (unsweetened)', servingSize: '8 fl oz (240ml)', servingUnit: 'cup', servingGrams: 240, calories: 0, protein: 0, carbs: 0, fat: 0, emoji: '🍵', category: 'drink', barcode: null, source: 'usda', tags: ['tea', 'drink', 'zero-cal'] },
  { id: 'pkg-39', brand: 'Coca-Cola', name: 'Diet Coke', servingSize: '12 fl oz can', servingUnit: 'can', servingGrams: 355, calories: 0, protein: 0, carbs: 0, fat: 0, emoji: '🥤', category: 'drink', barcode: '049000028928', source: 'openfoodfacts', tags: ['diet coke', 'soda', 'drink'] },
  { id: 'pkg-40', brand: 'Generic', name: 'Whole Milk Latte (nonfat)', servingSize: '16 fl oz', servingUnit: 'cup', servingGrams: 480, calories: 130, protein: 13, carbs: 18, fat: 0, emoji: '☕', category: 'drink', barcode: null, source: 'local', tags: ['latte', 'skinny', 'coffee', 'drink'] },
  { id: 'pkg-41', brand: 'Fairlife', name: 'Chocolate Protein Shake', servingSize: '11.5 fl oz bottle', servingUnit: 'bottle', servingGrams: 340, calories: 150, protein: 30, carbs: 6, fat: 2.5, emoji: '🥛', category: 'supplement', barcode: '850195005033', source: 'openfoodfacts', tags: ['protein shake', 'chocolate', 'fairlife'] },

  // ── Proteins (expanded) ───────────────────────────────────────
  { id: 'pkg-42', brand: 'Generic', name: 'Turkey Breast (deli sliced)', servingSize: '2 oz (56g)', servingUnit: 'slice', servingGrams: 56, calories: 60, protein: 12, carbs: 0, fat: 0.5, emoji: '🦃', category: 'protein', barcode: null, source: 'usda', tags: ['turkey', 'deli', 'lean', 'protein'] },
  { id: 'pkg-43', brand: 'Generic', name: 'Ground Turkey 93/7 (cooked)', servingSize: '100g', servingUnit: 'g', servingGrams: 100, calories: 189, protein: 27, carbs: 0, fat: 9, emoji: '🦃', category: 'protein', barcode: null, source: 'usda', tags: ['turkey', 'ground', 'protein'] },
  { id: 'pkg-44', brand: 'Generic', name: 'Shrimp (cooked)', servingSize: '100g', servingUnit: 'g', servingGrams: 100, calories: 99, protein: 24, carbs: 0, fat: 0.3, emoji: '🍤', category: 'protein', barcode: null, source: 'usda', tags: ['shrimp', 'seafood', 'protein'] },
  { id: 'pkg-45', brand: 'Generic', name: 'Protein Powder (generic whey)', servingSize: '1 scoop (30g)', servingUnit: 'scoop', servingGrams: 30, calories: 120, protein: 25, carbs: 3, fat: 1, emoji: '💪', category: 'supplement', barcode: null, source: 'local', tags: ['protein powder', 'whey', 'supplement'] },

  // ── Carbs (expanded) ──────────────────────────────────────────
  { id: 'pkg-46', brand: 'Generic', name: 'Sweet Potato (baked)', servingSize: '1 medium (130g)', servingUnit: 'potato', servingGrams: 130, calories: 112, protein: 2.1, carbs: 26, fat: 0.1, emoji: '🍠', category: 'grain', barcode: null, source: 'usda', tags: ['sweet potato', 'carb', 'vegetable'] },
  { id: 'pkg-47', brand: 'Generic', name: 'Baked Potato (plain)', servingSize: '1 medium (173g)', servingUnit: 'potato', servingGrams: 173, calories: 161, protein: 4.3, carbs: 37, fat: 0.2, emoji: '🥔', category: 'grain', barcode: null, source: 'usda', tags: ['potato', 'baked potato', 'carb'] },
  { id: 'pkg-48', brand: 'Generic', name: 'Pasta (cooked, plain)', servingSize: '1 cup (140g)', servingUnit: 'cup', servingGrams: 140, calories: 220, protein: 8, carbs: 43, fat: 1.3, emoji: '🍝', category: 'grain', barcode: null, source: 'usda', tags: ['pasta', 'noodles', 'carb'] },

  // ── Snacks (expanded) ─────────────────────────────────────────
  { id: 'pkg-49', brand: 'Generic', name: 'Air-Popped Popcorn', servingSize: '3 cups (24g)', servingUnit: 'cup', servingGrams: 24, calories: 93, protein: 3, carbs: 18, fat: 1, emoji: '🍿', category: 'snack', barcode: null, source: 'usda', tags: ['popcorn', 'snack', 'low-calorie'] },
  { id: 'pkg-50', brand: 'Lay\'s', name: 'Classic Potato Chips', servingSize: '1 oz (28g)', servingUnit: 'oz', servingGrams: 28, calories: 160, protein: 2, carbs: 15, fat: 10, emoji: '🥔', category: 'snack', barcode: '028400028066', source: 'openfoodfacts', tags: ['chips', 'potato chips', 'snack', 'lays'] },
  { id: 'pkg-51', brand: 'Generic', name: 'Rice Cakes (plain)', servingSize: '2 cakes (18g)', servingUnit: 'cake', servingGrams: 18, calories: 70, protein: 1.5, carbs: 15, fat: 0.3, emoji: '⬜', category: 'snack', barcode: null, source: 'usda', tags: ['rice cake', 'snack', 'low-calorie'] },
  { id: 'pkg-52', brand: 'General Mills', name: 'Cheerios', servingSize: '1 cup (28g)', servingUnit: 'cup', servingGrams: 28, calories: 100, protein: 3, carbs: 20, fat: 2, emoji: '🥣', category: 'snack', barcode: '016000275287', source: 'openfoodfacts', tags: ['cereal', 'cheerios', 'breakfast'] },
  { id: 'pkg-53', brand: 'Generic', name: 'Honey (1 tbsp)', servingSize: '1 tbsp (21g)', servingUnit: 'tbsp', servingGrams: 21, calories: 64, protein: 0.1, carbs: 17, fat: 0, emoji: '🍯', category: 'snack', barcode: null, source: 'usda', tags: ['honey', 'sweetener'] },
];
